...
asset_relpath = relpath(data_03_04_variant_asset, dirname(data_03_05_magician_payload_setDressing))


setDressing_stage = Usd.Stage.CreateNew(data_03_05_magician_payload_setDressing)
